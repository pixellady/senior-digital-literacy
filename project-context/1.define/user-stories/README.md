...
| ID | Title | Persona | PRD Anchor |
|----|-------|---------|------------|
| [US-001](US-001-scam-defense-hub-entry.md) | Scam Defense Hub Entry | Margaret | F1 |
| [US-002](US-002-check-suspicious-message.md) | Check Suspicious Message | Margaret | F1 |
| [US-003](US-003-scam-drills-quiz-streak.md) | Scam Drills, Quiz, and Streak | Margaret, Carmen | F1, F6 |
| [US-004](US-004-select-learning-track.md) | Select Learning Track | Margaret, Carmen | F2 |
| [US-005](US-005-switch-learning-track.md) | Switch Learning Track | Margaret | F2 |
| [US-006](US-006-goal-based-onboarding.md) | Goal-Based Onboarding | Margaret, Carmen | F3 |
| [US-007](US-007-step-by-step-tutoring.md) | Step-by-Step Tutoring | Margaret | F4 |
| [US-008](US-008-beginner-track-micro-steps.md) | Beginner Track Micro-Steps | Beginner / Margaret | F2, F4 |
| [US-009](US-009-pause-emotional-safety.md) | Pause and Emotional Safety | Margaret | F5 |
...
### Scam Defense First
US-001, US-002, US-003, US-014, US-020, US-021 (scam corpus)
...
| Persona | Stories |
|---------|---------|
| Margaret (Primary) | US-001–US-011, US-013, US-018–US-021 |
| David (Caregiver) | US-012, US-019 |
| Carmen (Public housing) | US-003, US-004, US-006, US-014–US-018 |
...
- Human escalation webhook / callback queue (**P1**)
- Spanish/English bilingual (P2) — Carmen full language support
- Freemium subscription (P1-1)
- Library/kiosk hardened mode (P1-3)
- Email/SMS Scam Defense reminders (P1-4)
- Carmen No-Device beta with partner (**Q4 2026**, P1-6)
...
- 21 MVP stories map to PRD P0 features and cross-cutting auth/accessibility requirements.
- SFS documents referenced as TBD until `@system.arch` creates feature specs.

...
4. **Given** critical risk during tutoring, **When** Safety Coach assesses, **Then** priority escalation (US-014) is offered and Tutor pauses sensitive steps.
...
- **In Scope for MVP**: Live scam signal detection in tutoring sessions; Coach interrupt; resume tutoring; escalation on critical risk.
